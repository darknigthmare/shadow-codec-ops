...
describe('MGS1 encyclopedia', () => {
  ...
  it('contains portrait variants for support and event contacts', () => { expect(getMgs1PortraitSets()).toHaveLength(10); expect(getMgs1PortraitSets().every((entry) => entry.expressions.length >= 6)).toBe(true); });
